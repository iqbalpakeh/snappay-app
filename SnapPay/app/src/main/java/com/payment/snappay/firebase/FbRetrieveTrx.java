...
public class FbRetrieveTrx extends FbContract {
    ...
    private FbRetrieveTrx(Context context, FbRetrieveTrxAble anInterface) {
        ...
        mTrxHistoryRef = mDatabase.child(FbContract.ROOT_CONSUMER).child(uid).child("transactions");
    }
        ...
        mListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot children : dataSnapshot.getChildren()) {
                    ...
                    String merchantId = children.child("merchantID").getValue().toString();
                    ...
                    if (type.equals("NFC")) {
                        ...
                        TrxNfc trxNfc = TrxNfc.build(timestamp, amount, merchantName, productName, merchantId);
                        ...
                        TrxQrc trxQrc = TrxQrc.build(timestamp, amount, merchantName, productName, merchantId);
                        ContentValues values = new ContentValues();
                        ...
                        TrxHce trxHce = TrxHce.build(timestamp, amount, merchantName, productName, merchantId);
                        ContentValues values = new ContentValues();
